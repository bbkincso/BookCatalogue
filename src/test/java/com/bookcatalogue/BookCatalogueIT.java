...
public class BookCatalogueIT {
    ...
    public void deleteBookByIdTest() {
        ...
        ResponseEntity<Void> response1 = restTemplate.exchange("http://localhost:8082/books/10",
                HttpMethod.DELETE, HttpEntity.EMPTY, Void.class);
        ResponseEntity<Void> response2 = restTemplate.exchange("http://localhost:8082/books/9",
                HttpMethod.DELETE, HttpEntity.EMPTY, Void.class);
